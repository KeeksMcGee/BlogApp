...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStop() {
        ...
        if(mAuthListener != null){
            ...
            //This ensures that if something happens, the auth listener is removed so we don't get a loop where people are reauthenticating themselves in the background
        }
    }
}
